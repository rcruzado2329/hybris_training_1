...
public interface ConsentService {
    ...
    /**
    *  Sets the profile consent in session
    */
    default void setProfileConsent(final boolean consent){
        //provided default impl for backward compatibility
        //override this.
        return;
    }
     ...
     * @return consent reference
     */
    default String getConsentReferenceFromHeader(final HttpServletRequest request){
        //provided default impl for backward compatibility
     ...
     */
    default void setProfileIdCookie(final HttpServletRequest request, final HttpServletResponse response, final String consentReferenceId){
        //provided default impl for backward compatibility
        //override this.
        return;
    }
