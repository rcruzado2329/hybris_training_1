...
angular__WEBPACK_IMPORTED_MODULE_0__["module"]('merchandisingExperienceInterceptorModule', ['interceptorHelperModule', 'functionsModule', 'smarteditServicesModule', 'resourceLocationsModule', 'yLoDashModule'])
     ...
     */
    .factory('merchandisingExperienceInterceptor', ["lodash", "sharedDataService", "interceptorHelper", "CONTEXT_CATALOG", "CONTEXT_CATALOG_VERSION", "MEDIA_PATH", "CONTEXT_SITE_ID", function (lodash, sharedDataService, interceptorHelper, CONTEXT_CATALOG, CONTEXT_CATALOG_VERSION, MEDIA_PATH, CONTEXT_SITE_ID) {
    'ngInject';
