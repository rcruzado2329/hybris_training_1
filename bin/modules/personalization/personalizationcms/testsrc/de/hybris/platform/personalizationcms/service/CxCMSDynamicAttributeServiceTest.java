...
public class CxCMSDynamicAttributeServiceTest
{
	...
	private static final Set<String> containerJspKeySet = Collections.set( //
			JSP_NAMES.containerId, //
			JSP_NAMES.containerType, //
			JSP_NAMES.sourceId);//

	private static final Set<String> actionsJspKeySet = Collections.set( //
			JSP_NAMES.containerId, //
			JSP_NAMES.containerType, //
			JSP_NAMES.sourceId, //
			JSP_NAMES.actionId, //
	...
	private static final Set<String> containerSpaKeySet = Collections.set( //
			SPA_NAMES.containerId, //
			SPA_NAMES.containerType, //
			SPA_NAMES.sourceId);//

	private static final Set<String> actionsSpaKeySet = Collections.set( //
			SPA_NAMES.containerId, //
			SPA_NAMES.containerType, //
			SPA_NAMES.sourceId, //
			SPA_NAMES.actionId, //
