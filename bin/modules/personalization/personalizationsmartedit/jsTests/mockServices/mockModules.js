window.setupMockModules = function(container) {
    ...
    angular.module('cmsSmarteditServicesModule', []);
    ...
    beforeEach(module('cmsSmarteditServicesModule', function($provide) {
    ...
    beforeEach(module('smarteditCommonsModule', function($provide) {
        ...
        container.crossFrameEventService = jasmine.createSpyObj('crossFrameEventService', ['subscribe', 'publish']);
        ...
        container.pageService = jasmine.createSpyObj('pageService', ['']);
        $provide.value('pageService', container.pageService);
    }));
    ...
    beforeEach(module('seConstantsModule', function($provide) {
        ...
        $provide.constant('SHOW_TOOLBAR_ITEM_CONTEXT', {
            SHOW_TOOLBAR_ITEM_CONTEXT: 'SHOW_TOOLBAR_ITEM_CONTEXT'
        });
        $provide.constant('HIDE_TOOLBAR_ITEM_CONTEXT', {
            HIDE_TOOLBAR_ITEM_CONTEXT: 'HIDE_TOOLBAR_ITEM_CONTEXT'
        });
    ...
    beforeEach(module('permissionServiceModule', function($provide) {
        container.permissionService = jasmine.createSpyObj('permissionService', ['isPermitted', 'registerRule', 'registerPermission']);
    ...
    beforeEach(module('catalogVersionPermissionModule', function($provide) {
        container.catalogVersionPermissionService = jasmine.createSpyObj('catalogVersionPermissionService', ['hasReadPermissionOnCurrent']);
        $provide.value("catalogVersionPermissionService", container.catalogVersionPermissionService);
    }));

    beforeEach(module('personalizationsmarteditServicesModule', function($provide) {
        container.personalizationsmarteditContextServiceProxy = jasmine.createSpyObj('personalizationsmarteditContextServiceProxy', ['setPersonalization', 'setCustomize', 'setCombinedView', 'setSeData']);
        $provide.value("personalizationsmarteditContextServiceProxy", container.personalizationsmarteditContextServiceProxy);
        container.personalizationsmarteditContextServiceReverseProxy = jasmine.createSpyObj('personalizationsmarteditContextServiceReverseProxy', ['applySynchronization']);
        $provide.value("personalizationsmarteditContextServiceReverseProxy", container.personalizationsmarteditContextServiceReverseProxy);
    }));
