...
public class ProductInterestsController
{
	...
	public ProductInterestEntryRelationWsDTO createProductInterest(
			...
			@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		return dataMapper.map(productInterestRelation, ProductInterestEntryRelationWsDTO.class, fields);
	}
