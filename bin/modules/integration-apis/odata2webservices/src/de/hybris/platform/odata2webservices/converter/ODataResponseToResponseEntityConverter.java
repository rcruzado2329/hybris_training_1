...
{
	private static final Logger LOGGER = LoggerFactory.getLogger(ODataResponseToResponseEntityConverter.class);
	...
	protected String extractPayload(final ODataResponse response)
	{
		...
		else
		{
			...
			{
				LOGGER.error("Failed to extract the payload from the response: ", e);
				throw new RuntimeIOException(e);
			}
			catch (final ODataException e)
			{
				LOGGER.error("An error was encountered while generating a response", e);
