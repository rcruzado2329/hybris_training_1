...
public class ODataPersistenceFacadeIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void cleanup()
	{
		...
		IntegrationTestUtil.removeAll(TestItemModel.class);
	}
	...
	@Test
	public void testPersistEntityWithAllPossiblePrimitiveAttributeTypes() throws ImpExException
	{
		givenTestItemIntegrationObjectExists();
		final ODataRequest request = postRequestBuilder("TestObject", "TestItems", APPLICATION_JSON_VALUE)
				.withBody(json()
		...
		ODataAssertions.assertThat(response)
				.hasStatus(HttpStatusCodes.CREATED)
				.jsonBody()
				.hasPathWithValue("d.string", "new-item")
				.hasPathWithValue("d.primitiveShort", "32767")
				.hasPathWithValue("d.primitiveChar", "b")
				.hasPathWithValue("d.primitiveInteger", "2147483647")
				.hasPathWithValue("d.primitiveByte", "127")
				.hasPathWithValue("d.primitiveBoolean", "true")
				.hasPathWithValue("d.primitiveFloat", "3.4028234")
				.hasPathWithValue("d.primitiveDouble", "1.7976931348623157")
				.hasPathWithValue("d.date", "/Date(1574665200000)/");

		final TestItemModel persistedItem = IntegrationTestUtil.findAny(TestItemModel.class, m -> "new-item".equals(m.getString()))
				.orElse(null);
		Assertions.assertThat(persistedItem)
				.isNotNull()
				.hasFieldOrPropertyWithValue("primitiveShort", Short.MAX_VALUE)
				.hasFieldOrPropertyWithValue("primitiveChar", 'b')
				.hasFieldOrPropertyWithValue("primitiveInteger", Integer.MAX_VALUE)
				.hasFieldOrPropertyWithValue("primitiveByte", Byte.MAX_VALUE)
				.hasFieldOrPropertyWithValue("primitiveBoolean", true)
				.hasFieldOrPropertyWithValue("primitiveFloat", 3.4028235f)
				.hasFieldOrPropertyWithValue("primitiveDouble", 1.7976931348623157d)
				.hasFieldOrPropertyWithValue("date", new Date(1574665200000L));
	}
	...
	private void givenTestItemIntegrationObjectExists() throws ImpExException
	{
		IntegrationTestUtil.importImpEx(
				...
				"; TestObject:TestItem	; primitiveBoolean	; TestItem:primitiveBoolean	;",
				"; TestObject:TestItem	; primitiveShort  	; TestItem:primitiveShort  	;",
				"; TestObject:TestItem	; primitiveChar   	; TestItem:primitiveChar   	;",
				"; TestObject:TestItem	; primitiveInteger	; TestItem:primitiveInteger	;",
				"; TestObject:TestItem	; primitiveByte   	; TestItem:primitiveByte   	;",
				"; TestObject:TestItem	; primitiveFloat  	; TestItem:primitiveFloat  	;",
				"; TestObject:TestItem	; primitiveDouble 	; TestItem:primitiveDouble 	;",
