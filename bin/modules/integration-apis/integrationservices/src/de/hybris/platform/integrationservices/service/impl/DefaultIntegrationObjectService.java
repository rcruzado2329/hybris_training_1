...
public class DefaultIntegrationObjectService implements IntegrationObjectService
{
	...
	public Set<IntegrationObjectItemModel> findAllDependencyTypes(final String integrationObjectItemCode, final String integrationObjectCode)
	{
		...
		{
			final Optional<IntegrationObjectItemModel> integrationObjectOptional = findIntegrationObjectItem(integrationObjectCode, integrationObjectItemCode);
	...
	{
		final Optional<IntegrationObjectItemModel> integrationObjectItem = findIntegrationObjectItem(integrationObjectCode, integrationObjectItemCode);
		if (integrationObjectItem.isPresent())
		{
	...
	@Override
	public Optional<IntegrationObjectItemModel> findIntegrationObjectItem(final String integrationObjectCode, final String integrationObjectItemCode)
	{
