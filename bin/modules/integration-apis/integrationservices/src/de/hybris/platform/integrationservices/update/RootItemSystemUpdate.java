...
{
	private static final Logger LOGGER = LoggerFactory.getLogger(RootItemSystemUpdate.class);
	...
	{
		LOGGER.info("Setting IntegrationObjectItem.root=false for all existing IntegrationObjectItems without a set root item.");
