...
public class FromClauseBuilder
{
	...
	private String createJoinStatements()
	{
		if (filter != null)
		{
			return filter.getConditions().stream()
			             .map(this::translateAttributeNameToQualifier)
	...
	private  WhereClauseCondition translateAttributeNameToQualifier(final WhereClauseCondition condition)
	{
	...
	{
		return isAttributeSource(attributeDescriptorModel, condition.getAttributeName())
