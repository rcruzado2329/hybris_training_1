...
class LocalizedValueUnitTest extends Specification {
    ...
    @Test
    def "can combine values from another LocalizedValue"() {
        given:
        def value1 = LocalizedValue.of(Locale.ENGLISH, 'english')
        ...
        then:
        combined.get(Locale.ENGLISH) == 'english'
        combined.get(Locale.GERMAN) == 'german'
    }

    @Test
    def "previously set value can be reset"() {
        given:
        def original = LocalizedValue.of(Locale.ENGLISH, 'one')
