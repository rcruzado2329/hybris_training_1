...
class ClauseBuilderUtilUnitTest extends Specification {
	...
	def "get AttributeDescriptorModel from filter #filter returns an Optional with isPresent equals #present"() {
		...
		new WhereClauseCondition("{target} = 1234") | itemWithDeclaredRelation() | true
		new WhereClauseCondition("{target} = 1234") | itemWithDeclaredRelation() | true
		new WhereClauseCondition("{source} = 1234") | itemWithDeclaredRelation() | true
		new WhereClauseCondition("{inheritedTarget} = 1234") | itemWithInheritedRelation() | true
		new WhereClauseCondition("{inheritedSource} = 1234") | itemWithInheritedRelation() | true
	}
