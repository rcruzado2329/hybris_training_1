...
public class SchemaGeneratorIntegrationTest extends ServicelayerTest
{
	...
	@Test
	public void testGeneratesSchemaForAllPossiblePrimitiveAttributeTypes() throws ImpExException
	{
		IntegrationTestUtil.importImpEx(
				"INSERT_UPDATE IntegrationObject; code[unique = true]; integrationType(code)",
				"; TestObject; INBOUND",
				"INSERT_UPDATE IntegrationObjectItem; integrationObject(code)[unique=true]; code[unique = true]; type(code)",
				"; TestObject	; TestItem	; TestItemType2",
				...
				"; TestObject:TestItem	; string          	; TestItemType2:string          	; true",
				"; TestObject:TestItem	; boolean         	; TestItemType2:boolean         	;",
				"; TestObject:TestItem	; primitiveBoolean	; TestItemType2:primitiveBoolean	;",
				"; TestObject:TestItem	; primitiveShort  	; TestItemType2:primitiveShort  	;",
				"; TestObject:TestItem	; character       	; TestItemType2:character       	;",
				"; TestObject:TestItem	; primitiveChar   	; TestItemType2:primitiveChar   	;",
				"; TestObject:TestItem	; integer         	; TestItemType2:integer         	;",
				"; TestObject:TestItem	; primitiveInteger	; TestItemType2:primitiveInteger	;",
				"; TestObject:TestItem	; byte            	; TestItemType2:byte            	;",
				"; TestObject:TestItem	; primitiveByte   	; TestItemType2:primitiveByte   	;",
				"; TestObject:TestItem	; long            	; TestItemType2:long            	;",
				"; TestObject:TestItem	; primitiveLong   	; TestItemType2:primitiveLong   	;",
				"; TestObject:TestItem	; float           	; TestItemType2:float           	;",
				"; TestObject:TestItem	; primitiveFloat  	; TestItemType2:primitiveFloat  	;",
				"; TestObject:TestItem	; double          	; TestItemType2:double          	;",
				"; TestObject:TestItem	; primitiveDouble 	; TestItemType2:primitiveDouble 	;",
				"; TestObject:TestItem	; date            	; TestItemType2:date            	;");

		final Schema generated = generator.generateSchema(getIntegrationObjectItemModelDefinitions());

		final ODataSchema schema = new ODataSchema(generated);
		assertThat(schema.getEntityType("TestItem").getPropertyNames())
				.contains("string", "boolean", "primitiveBoolean", "primitiveShort",
						"character", "primitiveChar", "integer", "primitiveInteger", "byte", "primitiveByte",
						"long", "primitiveLong", "float", "primitiveFloat", "double", "primitiveDouble", "date");
	}
