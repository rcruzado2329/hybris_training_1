...
public class EditorValidatorUnitTest {
    ...
    public void validateDefintionsValidTest() {
        ...
        final ListItemDTO itemSelect = new ListItemDTO(baseADM, false, true, ListItemStructureType.NONE, false, "");
        final ListItemDTO itemNotSelect = new ListItemDTO(baseADM, false, false, ListItemStructureType.NONE, false, "");
    ...
    public void validateHasKeyValidTest() {
        ...
        final ListItemDTO itemUnique = new ListItemDTO(a1, false, true, ListItemStructureType.NONE, false, "");
        final ListItemDTO itemCustomUnique = new ListItemDTO(baseADM, true, true, ListItemStructureType.NONE, false, "");
        final ListItemDTO itemSelect = new ListItemDTO(baseADM, false, true, ListItemStructureType.NONE, false, "");
        final ListItemDTO itemNotSelect = new ListItemDTO(baseADM, false, false, ListItemStructureType.NONE, false, "");
