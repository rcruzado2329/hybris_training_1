...
{
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractRestTemplateCreator.class);
	...
	public RestOperations create(final ConsumedDestinationModel destination)
	{
		if (isApplicable(destination))
		{
			...
			synchronized (syncObj)
			{
				...
				{
					LOGGER.debug("Cache doesn't contain the rest template for '{}', creating and caching a rest template", key.getDestinationId());
